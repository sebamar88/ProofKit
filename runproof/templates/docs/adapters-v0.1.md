...
# ProofKit Runtime Adapters v0.1

ProofKit keeps the protocol independent from any specific agent. Runtime adapters describe how a concrete tool should apply the same `.sdd` artifacts, roles, skills, and verification gates.
...
Adapters map portable ProofKit contracts to runtime behavior:
...
Concrete runtime automation can build on these manifests without changing the ProofKit protocol.
